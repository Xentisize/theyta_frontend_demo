...
import { sentenceSuggestion } from "../sentenceSuggestions";
...
const dummyMentionsData = sentenceSuggestion;
...
function getPossibleQueryMatch(text) {
	const match = checkForAtSignMentions(text, 3);
...
export default function NewMentionsPlugin() {
	...
	const options = useMemo(
		() =>
			results
				.map((result) => new MentionTypeaheadOption(result, <i className="icon plus" />))
