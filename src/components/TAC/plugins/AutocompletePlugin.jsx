...
function $search(selection) {
	...
	const joinedText = word.reverse().join("");
	console.log("$search: ", joinedText);
	return [true, joinedText];
}
	...
	query = (searchText) => {
		...
		const promise = new Promise((resolve, reject) => {
			setTimeout(() => {
				...
				console.log("In Promise - Before search");
				const searchTextLength = searchText.length;
				if (searchText === "" || searchTextLength < 4) {
					console.log("Returned null ", searchText);
					return resolve(null);
				}
				...
				console.log("In Promise: after match ", match);
				if (match === undefined) {
					return resolve(null);
				}
				...
				console.log("Chunk: ", autocompleteChunk);
